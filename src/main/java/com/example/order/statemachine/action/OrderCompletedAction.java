...
//
//import static com.example.order.controller.RabbitMqConfig.COMPLETED_MESSAGE_QUEUE;
...
//
//@Component
//public class OrderCompletedAction implements Action<OrderState, OrderEvent> {
//
//    @Autowired
...
//        rabbitTemplate.convertAndSend(COMPLETED_MESSAGE_QUEUE, orderId);
//    }
//}
