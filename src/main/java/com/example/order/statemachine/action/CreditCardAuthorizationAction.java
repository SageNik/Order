...
@Component
public class CreditCardAuthorizationAction implements Action<OrderState, OrderEvent> {
    ...
    public void execute(StateContext<OrderState, OrderEvent> stateContext) {
        ...
        AccountMessageDto messageDto = ORDER_MAPPER.mapToAccountMessageDto(order, totalPrice, AccountMessageType.AUTHORIZATION);
