...
@Component
public class TicketCreationAction implements Action<OrderState, OrderEvent> {
    ...
    public void execute(StateContext<OrderState, OrderEvent> stateContext) {
        ...
        ManufactureMessageDto messageDto = ORDER_MAPPER.mapToManufactureMessageDto(order, ManufactureMessageType.TICKET_CREATION);
